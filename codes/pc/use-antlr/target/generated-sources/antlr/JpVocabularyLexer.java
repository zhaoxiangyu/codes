...
public class JpVocabularyLexer extends Lexer {
    ...
    public final void mPartOfSpeech() throws RecognitionException {
        try {
            ...
            if ( ((LA4_0>='0' && LA4_0<='9')||(LA4_0>='\uFF10' && LA4_0<='\uFF19')) ) {
                alt4=1;
            }
            switch (alt4) {
                case 1 :
        ...
        try {
            ...
            if ( ((LA6_0>='\u4E00' && LA6_0<='\u9FA5')) ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("232:1: Expl : ( ( KANJI | ALPHA | PUNC | FTILDE ) ( KANJI | ALPHA | PUNC | FTILDE | LBR | RBR | LPA | RPA )* ( KANJI | ALPHA | PUNC | RPA | RBR ) | KANJI );", 6, 0, input);
    ...
    public final void mSuffix1() throws RecognitionException {
        try {
            ...
            else if ( ((LA7_0>='\u30A0' && LA7_0<='\u30FF')) ) {
                alt7=2;
            }
            else {
                NoViableAltException nvae =
                    new NoViableAltException("245:7: (h1= HINA | k1= KATA )", 7, 0, input);
            ...
            switch (alt7) {
                case 1 :
                    ...
                    mHINA(); 
                    h1 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, h1Start309, getCharIndex()-1);
                    pronu+=h1.getText();
                ...
                case 2 :
                    ...
                    mKATA(); 
                    k1 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, k1Start316, getCharIndex()-1);
                    pronu+=k1.getText();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    mHINA(); 
            	    h2 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, h2Start330, getCharIndex()-1);
            	    pronu+=h2.getText();
            	...
            	case 2 :
            	    ...
            	    mKATA(); 
            	    k2 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, k2Start337, getCharIndex()-1);
            	    pronu+=k2.getText();
            	...
            	case 3 :
            	    ...
            	    mKANJI(); 
            	    KANJI1 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, KANJI1Start351, getCharIndex()-1);
            	    pronu+=KANJI1.getText();
            	...
            	case 4 :
            	    ...
            	    mGRM_PUNC(); 
            	    GRM_PUNC2 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, GRM_PUNC2Start356, getCharIndex()-1);
            	    pronu+=GRM_PUNC2.getText();
            	...
            	case 7 :
            	    ...
            	    mFTILDE(); 
            	    ft2 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, ft2Start381, getCharIndex()-1);
            	    pronu+=ft2.getText();
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    mKANJI(); 
            	    KANJI4 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, KANJI4Start431, getCharIndex()-1);
            	    wr+=KANJI4.getText();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    mHINA(); 
            	    h1 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, h1Start439, getCharIndex()-1);
            	    pronu+=h1.getText();
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    mKANJI(); 
            	    KANJI6 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, KANJI6Start494, getCharIndex()-1);
            	    wr+=KANJI6.getText();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    mHINA(); 
            	    h1 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, h1Start502, getCharIndex()-1);
            	    wr+=h1.getText();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    mHINA(); 
            	    h2 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, h2Start519, getCharIndex()-1);
            	    pronu+=h2.getText();
    ...
    static final String DFA16_eotS =
        "\1\uffff\2\5\1\10\1\5\1\uffff\1\22\2\uffff\1\24\3\uffff\3\5\1\uffff"+
        "\1\5\4\uffff\1\10\3\5\1\10\1\5\1\uffff\1\44\3\5\1\10\3\uffff\1\5"+
        "\1\uffff\1\5\1\10\2\5\1\10\2\5\1\61\2\5\2\uffff\2\5\1\uffff";
    static final String DFA16_eofS =
        "\66\uffff";
    static final String DFA16_minS =
        "\1\0\2\u3093\1\uff08\1\u305f\1\uffff\1\60\2\uffff\1\50\3\uffff\1"+
        "\u30e5\1\u307e\1\u308a\1\50\1\u3057\4\uffff\1\50\1\u30fc\1\u308a"+
        "\1\u306e\1\uff09\1\40\2\50\1\u305b\1\u3000\1\u3061\1\uff0c\3\uffff"+
        "\1\u3044\1\uffff\1\u3087\1\u5f04\1\u3067\1\u3046\1\u6e05\1\u3093"+
        "\1\u3058\1\50\1\uff08\1\u3087\2\uffff\1\u3046\1\uff08\1\uffff";
    static final String DFA16_maxS =
        "\1\uff5e\1\u30ad\1\u3093\1\uff08\1\u305f\1\uffff\1\uff5e\2\uffff"+
        "\1\uff5e\3\uffff\1\u30e5\1\u307e\1\u308a\1\uff5e\1\u3057\4\uffff"+
        "\1\uff08\1\u30fc\1\u308a\1\u306e\1\uff09\1\40\1\uff5e\1\uff08\1"+
        "\u305b\1\u3000\1\u3061\1\uff0c\3\uffff\1\u3044\1\uffff\1\u3087\1"+
        "\u5f04\1\u3067\1\u3046\1\u6e05\1\u3093\1\u3058\1\uff5e\1\uff08\1"+
        "\u3087\2\uffff\1\u3046\1\uff08\1\uffff";
    static final String DFA16_acceptS =
        "\5\uffff\1\6\1\uffff\1\10\1\11\1\uffff\1\16\1\20\1\21\5\uffff\1"+
        "\15\1\7\1\17\1\12\14\uffff\1\5\1\14\1\13\1\uffff\1\1\12\uffff\1"+
        "\4\1\2\2\uffff\1\3";
