...
import org.sharp.swing.utils.SwingUtils.NewIntegerHandler;
import org.sharp.swing.utils.SwingUtils.SpinnerHandler;
...
public class TermNavPanel extends JPanel {
	...
	public String getPartOfSpeech(String def){
		if(pos!=null)
			return Utils.defaultIfNull(pos.getPartofspeech(), def);
		return def;
	}
	...
	public void setTerm(final Term t, String wPos, int wEntryNo){
		...
		if(t!=null){
			...
			if(pos == null)
				pos = Utils.elementAt(t.getPses(), 0);
			int posi = Utils.at(t.getPses(), pos, 0);
