package org.sharp.swing.apps.el;
...
import org.sharp.swing.apps.el.intf.TagHandler;
import org.sharp.swing.apps.el.intf.VoicePronouncer;
import org.sharp.swing.apps.el.ui.ConfigPanel;
import org.sharp.swing.apps.el.ui.DocNewWordsPanel;
import org.sharp.swing.apps.el.ui.DocPhrasesPanel;
import org.sharp.swing.apps.el.ui.DocSearchPanel;
import org.sharp.swing.apps.el.ui.FileChoosePanel;
import org.sharp.swing.apps.el.ui.HtmlArticlePanel;
import org.sharp.swing.apps.el.ui.HtmlDictPanel;
import org.sharp.swing.apps.el.ui.OxfordA7Panel;
import org.sharp.swing.apps.el.ui.WordTagsPanel;
import org.sharp.swing.apps.el.ui.ConfigPanel.AdminHandler;
import org.sharp.swing.apps.el.ui.DocNewWordsPanel.WordListGenerator;
import org.sharp.swing.apps.el.ui.FileChoosePanel.ArticlesLoader;
import org.sharp.swing.apps.el.ui.widget.FileListPanel;
...
import org.sharp.swing.apps.el.utils.TermUtils;
	...
	public static class Runtime {
				...
				lucene.indexDoc(config.getIndexPath(), new Lucene.Indexable() {
					public Document toDocument() {
						...
						doc.add(new Field(FN_NW_EXPL, 
								Utils.defaultIfNull(nw.getNotes(),""), 
								Field.Store.YES,
								Field.Index.ANALYZED,
								Field.TermVector.WITH_POSITIONS_OFFSETS ));
						
						doc.add(new Field(FN_NW_TAG, 
								Utils.defaultIfNull(NewWordsUtils.getTagString(nw),"") ,
								Field.Store.YES,
								Field.Index.ANALYZED,
								Field.TermVector.WITH_POSITIONS_OFFSETS ));
						return doc;
		...
		TagHandler tagHandler = new TagHandler(){
			public void saveTag(Tag tag) {
				Utils.saveJox2(FilenameUtils.concat(appCtx.dataDirPath(),
						"Tags_"+tag.getName()+".xml"), tag);
			}
			
			public Tag loadTag(String rootName){
				Tag t = Utils.loadJox2(FilenameUtils.concat(appCtx.dataDirPath(),
		...
		FileHandler fileChoosedByUser = new FileHandler() {
			public void setInput(File file) {
				...
				Utils.add(articles, article, false);
