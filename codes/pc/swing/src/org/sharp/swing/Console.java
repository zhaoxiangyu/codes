...
import org.sharp.intf.Pluggable.AppLifeCycle;
...
import org.sharp.swing.apps.beans.Config;
import org.sharp.swing.apps.beans.Constants;
import org.sharp.swing.apps.beans.UserInfo;
import org.sharp.swing.utils.SwingUtils;
import org.sharp.swing.utils.TrayUtils;
...
public class Console {
	...
	static AppContext appContext = new AppContext() {
		...
		public <T> T getConfig(String name, Class<T> clazz) {
			return Utils.loadJox2(
					FilenameUtils.concat(dataDirPath(),name+".xml"), 
	...
	private static Pluggable[] loadModules(Reader reader){
		...
		String[] mcna = StringUtils.split(mns, ";");
