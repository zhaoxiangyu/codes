...
import org.sharp.swing.apps.el.beans.{Article,Phrase, NewWord}
import org.sharp.utils.scala.beans.{Article => Arti, Para => Par, Phrase => Phras, NewWord => NewWor}
import org.sharp.utils.scala.ArticleParsers
