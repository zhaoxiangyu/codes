...
public class TermUtils {
	...
	public static Meaning meaning(PartOfSpeech pos, int num, Meaning def) {
		if(pos == null)
			return def;
		return DsUtils.elementAt(pos.getMeaning(), num, def);
	}
	...
	public static void save(String termSavedFullDir, Term t) {
		FsUtils.saveJox2(FilenameUtils.concat(termSavedFullDir,t.getKey()+".xml"),t);
	}
	
	public static Term load(String termSavedFullDir, String key) {
		return FsUtils.loadJox2(FilenameUtils.concat(termSavedFullDir,key+".xml"),Term.class,null);
	}
}
