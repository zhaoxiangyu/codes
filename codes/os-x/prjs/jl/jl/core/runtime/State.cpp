...
State::State()
{
    ...
    (*levelStates)[0]=new LevelState(0,0,0);
    (*levelStates)[1]=new LevelState(1,0,0);
    (*levelStates)[2]=new LevelState(2,0,0);
    (*levelStates)[3]=new LevelState(3,0,0);
    (*levelStates)[4]=new LevelState(4,0,0);
    (*levelStates)[5]=new LevelState(5,0,0);
...
void State::fromString(string str){
    ...
    (*levelStates)[0]=new LevelState(level,current,last);
