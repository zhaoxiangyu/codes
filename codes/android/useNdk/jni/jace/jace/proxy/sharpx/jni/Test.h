...
#define JACE_PROXY_SHARPX_JNI_TEST_H
...
/**
 * The Jace C++ proxy class for sharpx/jni/Test.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class Test : public virtual ::jace::proxy::java::lang::Object {
 ...
 *
 */
::jace::proxy::java::lang::String testJniCpp( ::jace::proxy::types::JInt p0 );

/**
 * callBack
 *
 */
void callBack( ::jace::proxy::java::lang::String p0 );
...
Test( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< Test> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::sharpx::jni::Test>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::sharpx::jni::Test>::ElementProxy( const jace::ElementProxy< ::jace::proxy::sharpx::jni::Test>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::sharpx::jni::Test>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::sharpx::jni::Test>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::sharpx::jni::Test>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::sharpx::jni::Test>& object );
#else
...
#endif // #ifndef JACE_PROXY_SHARPX_JNI_TEST_H
