...
public class WakeOnLan {
	...
	/*192.168.1.99 00-25-64-86-1F-FD*/
	public static void wake(String ipStr, String macStr) throws Exception{
		try {
			...
			throw new Exception("Failed to send Wake-on-LAN packet: + e");
		}
