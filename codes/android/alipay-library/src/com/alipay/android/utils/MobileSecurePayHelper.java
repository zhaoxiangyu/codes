...
import com.alipay.android.NetworkManager;
...
public class MobileSecurePayHelper {
	 ...
	 */
	private static PackageInfo getApkInfo(Context context, String archiveFilePath) {
	...
	private JSONObject sendCheckNewUpdate(String versionName) {
	...
	private JSONObject sendRequest(final String content) {
	...
	//
	// 动态下载
	private boolean retrieveApkFromNet(Context context, String strurl,
			String filename) {
		boolean bRet = false;
