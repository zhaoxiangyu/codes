...
$.fn.floatPanel = function(a) {
	...
	$("<div class='searchMain'><div id='searchBtnCon2'><button id='searchBtn2'></button></div><div id='clear2'></div><div id='searchPan'><div class='searchPan_con'></div></div><div id='clear'></div><div id='searchBtnCon'><button id='searchBtn'></button></div></div>").prependTo($("body"));
